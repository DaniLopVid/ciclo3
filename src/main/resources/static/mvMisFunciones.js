function traerInformacionCategorias(){
    $.ajax({
        url:"http://168.138.131.29:8080/api/MVCategory/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        url:"http://168.138.131.29:8080/api/MVCategory/save",
...
function editarRegistro (id){
	$.ajax({    
    url : 'http://168.138.131.29:8080/api/MVCategory/'+id,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
  
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://168.138.131.29:8080/api/MVCategory/"+id);
        let miTabla = '<table>';
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://168.138.131.29:8080/api/MVCategory/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCategoria(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://168.138.131.29:8080/api/MVCategory/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
