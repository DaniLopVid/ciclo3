function traerInformacionMotorbikes(){
    $.ajax({
        url:"http://168.138.147.16:8080/api/Motorbike/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionMotorbikes(){
    let var3 = {
        ...
        url:"http://168.138.147.16:8080/api/Motorbike/save",
...
function editarRegistro (id){
	$.ajax({    
    url : 'http://168.138.147.16:8080/api/Motorbike/'+id,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
  
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://168.138.147.16:8080/api/Motorbike/"+id);
        let miTabla = '<table>';
...
function actualizarInformacionMotorbikes(idElemento){
    ...
    $.ajax({
        url:"http://168.138.147.16:8080/api/Motorbike/update",
        type:"PUT",
        data:dataToSend,
...
function borrarMotorbikes(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://168.138.147.16:8080/api/Motorbike/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
