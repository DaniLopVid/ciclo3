function traerInformacionCategorias(){
    $.ajax({
        url:"http://168.138.147.16:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        url:"http://168.138.147.16:8080/api/Category/save",
...
function editarRegistro (id){
	$.ajax({    
    url : 'http://168.138.147.16:8080/api/Category/'+id,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
  
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://168.138.147.16:8080/api/Category/"+id);
        let miTabla = '<table>';
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://168.138.147.16:8080/api/Category/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCategoria(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://168.138.147.16:8080/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
