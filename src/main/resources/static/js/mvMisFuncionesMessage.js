function traerInformacionMensajes(){
    $.ajax({
        url:"http://168.138.147.16:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionMensajes(){
    let var5 = {
        ...
        url:"http://168.138.147.16:8080/api/Message/save",
...
function editarRegistro (idMessage){
	$.ajax({    
    url : 'http://168.138.147.16:8080/api/Message/'+idMessage,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
  
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://168.138.147.16:8080/api/Message/"+idMessage);
        let miTabla = '<table>';
...
function actualizarInformacionMensajes(idElemento){
    ...
    $.ajax({
        url:"http://168.138.147.16:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
...
function borrarMensajes(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://168.138.147.16:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
